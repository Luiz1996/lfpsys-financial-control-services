package com.lfpsys.lfpsys_financial_control_services.kafka;
...
public class KafkaConfig {
  ...
  public static final String TOPIC_NAME = "financial_control";
  public static final String DLT_TOPIC_NAME = "financial_control.DLT";
